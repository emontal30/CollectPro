// Shared icons for all modals and popups throughout the application
export const SHARED_ICONS = {
  // Professional app icon with gradient background
...
// Function to get icon HTML with consistent styling
