...
### 4. إعداد Google OAuth في Supabase
...
4. أضف Redirect URLs:
   - `http://localhost:3000/dashboard.html` (للتطوير)
   - `https://your-domain.vercel.app/dashboard.html` (للإنتاج)
